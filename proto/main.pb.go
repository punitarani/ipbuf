...
func (x *IPBuf) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IPBuf) ProtoMessage() {}

func (x *IPBuf) ProtoReflect() protoreflect.Message {
	mi := &file_proto_main_proto_msgTypes[0]
...
// Deprecated: Use IPBuf.ProtoReflect.Descriptor instead.
func (*IPBuf) Descriptor() ([]byte, []int) {
	return file_proto_main_proto_rawDescGZIP(), []int{0}
}

func (x *IPBuf) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_proto_main_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x05, 0x69, 0x70, 0x62, 0x75, 0x66, 0x22, 0x19, 0x0a, 0x05, 0x49, 0x50, 0x42,
	0x75, 0x66, 0x12, 0x10, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x4d, 0x73, 0x67, 0x42, 0x03, 0x5a, 0x01, 0x2e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
